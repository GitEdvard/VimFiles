...
vim.keymap.set('n', ']d', remapping.remap_next_diagnose, bufopts)
vim.keymap.set('n', '[d', remapping.remap_previous_diagnose, bufopts)
...
vim.keymap.set('n', 'zo', remapping.remap_open_fold, bufopts)
vim.keymap.set('n', 'zc', remapping.remap_close_fold, bufopts)
vim.keymap.set('n', ']|', remapping.remap_next_table_column, bufopts)
vim.keymap.set('n', '[|', remapping.remap_previous_table_fold, bufopts)
