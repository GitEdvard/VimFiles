...
nnoremap <leader>tt :e! <cr> :normal! mT<cr> :AttachTestMethod<cr> :echom "Bookmark is set to T"<cr>
nnoremap <leader>tu :e! <cr> :normal! mT<cr> :AttachTestMethodUnique<cr> :echom "Bookmark is set to T"<cr>
